    ...
    config = mkIf cfg.enable (
        lib.mkMerge [
            (mkIf (cfg.emulator == "kitty") {
                wayland.windowManager.hyprland.settings.bindd = [ "SUPER, T, Launch Terminal, exec, kitty" ];
            ...
            (mkIf (cfg.emulator == "foot") {
                wayland.windowManager.hyprland.settings.bindd = [ "SUPER, T, Launch Terminal, exec, foot" ];
            ...
            (mkIf (cfg.emulator == "alacritty") {
                ...
                "SUPER, T, Launch Terminal, exec, alacritty"
                ];
